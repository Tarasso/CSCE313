...
void event_polling_thread (int n, int p, int w, int mb, FIFORequestChannel** wchans, BoundedBuffer* requestBuffer, HistogramCollection* hc) {
    char buf [1024];
    char recvbuf [mb];
...
int main(int argc, char *argv[])
{
    ...
    {
        filethread = thread(file_thread_function, fname, &requestBuffer, chan, m);
